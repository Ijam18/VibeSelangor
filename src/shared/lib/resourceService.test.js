...
export const testResourceService = {
    async testGetResources() {
        ...
        try {
            ...
            console.log('âœ“ get resources successful');
            return resources;
        } catch (err) {
            console.error('âœ— get resources failed:', err);
            throw err;
        }
    },
    ...
    async testAddResource() {
        ...
        try {
            ...
            console.log('âœ“ add resource successful');
            return result;
        } catch (err) {
            console.error('âœ— add resource failed:', err);
            throw err;
        }
    },
    ...
    async testUpdateResource() {
        ...
        try {
            ...
            console.log('âœ“ update resource successful');
            return result;
        } catch (err) {
            console.error('âœ— update resource failed:', err);
            throw err;
        }
    },
    ...
    async testDeleteResource() {
        ...
        try {
            ...
            console.log('âœ“ delete resource successful');
            return result;
        } catch (err) {
            console.error('âœ— delete resource failed:', err);
            throw err;
        }
    },
    ...
    async testGetFeaturedResources() {
        ...
        try {
            ...
            console.log('âœ“ get featured resources successful');
            return featured;
        } catch (err) {
            console.error('âœ— get featured resources failed:', err);
            throw err;
        }
    },
    ...
    async testSearchResources() {
        ...
        try {
            ...
            console.log('âœ“ search resources successful');
            return results;
        } catch (err) {
            console.error('âœ— search resources failed:', err);
            throw err;
        }
    },
    ...
    async testSortResources() {
        ...
        try {
            ...
            console.log('âœ“ sort resources successful');
            return sorted;
        } catch (err) {
            console.error('âœ— sort resources failed:', err);
            throw err;
        }
    },
    ...
    testSubscribeToChanges() {
        ...
        try {
            ...
            console.log('âœ“ subscribe to changes successful');
            return unsubscribe;
        } catch (err) {
            console.error('âœ— subscribe to changes failed:', err);
            throw err;
        }
    }
};
...
export const runAllTests = async () => {
    console.log('ðŸ§ª Running Resource Service Tests...\n');
