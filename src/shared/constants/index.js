...
export const GAME_ITEMS = [
    { id: 'desk_basic', name: 'Basic Desk', cost: 0, buildRate: 1, level: 1, emoji: 'ðŸª‘' },
    { id: 'laptop', name: 'Laptop', cost: 100, buildRate: 3, level: 1, emoji: 'ðŸ’»' },
    { id: 'coffee', name: 'Coffee Mug', cost: 50, buildRate: 1, level: 1, emoji: 'â˜•' },
    { id: 'plant', name: 'Office Plant', cost: 80, buildRate: 1, level: 2, emoji: 'ðŸŒ±' },
    { id: 'bookshelf', name: 'Tech Bookshelf', cost: 200, buildRate: 5, level: 2, emoji: 'ðŸ“š' },
    { id: 'selangor_flag', name: 'Selangor Flag', cost: 250, buildRate: 5, level: 2, emoji: 'ðŸ´' },
    { id: 'whiteboard', name: 'Whiteboard', cost: 300, buildRate: 7, level: 3, emoji: 'ðŸ“‹' },
    { id: 'monitor_dual', name: 'Dual Monitors', cost: 500, buildRate: 10, level: 3, emoji: 'ðŸ–¥ï¸' },
    { id: 'standing_desk', name: 'Standing Desk', cost: 400, buildRate: 8, level: 4, emoji: 'ðŸ‹ï¸' },
    { id: 'trophy', name: 'Sprint Trophy', cost: 1000, buildRate: 15, level: 5, emoji: 'ðŸ†' },
    { id: 'rocket', name: 'Rocket Model', cost: 800, buildRate: 12, level: 5, emoji: 'ðŸš€' },
    { id: 'server_rack', name: 'Server Rack', cost: 1500, buildRate: 20, level: 7, emoji: 'ðŸ–§' },
];
